...
productRouter.get('/get-product-name', asyncHandler(ProductController.seachNameProduct))
productRouter.get('/get-product-top-search', asyncHandler(ProductController.getProductTopSearch))
